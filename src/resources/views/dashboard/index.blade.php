                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            <div
                                ...
                                <img src="https://openweathermap.org/img/wn/{{ $city->weather_icon }}@2x.png"
                        ...
                        <div class="card-footer p-3 text-center">
                            <p class="mb-0">
                                <i class="fa fa-arrow-down text-info" aria-hidden="true"></i>
                                <span class="font-weight-bold">{{ $city->temp_min }}º</span>
                                <i class="fa fa-arrow-up text-danger" aria-hidden="true"></i>
                                <span class="font-weight-bold">{{ $city->temp_max }}º</span>
                            </p>
                            <div class="text-center pt-1">
                                <p class="text-xs mb-0">Última atualização: {{ $city->updated_at->format('d/m/Y H:i:s') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
